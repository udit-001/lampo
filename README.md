# Lampo: WiZ Smart Bulb Controller for Flutter

**Lampo** is a local-first **WiZ smart bulb controller** built with Flutter, talking directly to your bulbs over UDP (port 38899) on your LAN. No cloud account, no internet: just your phone and your bulbs on the same WiFi.

## Why does WiZ need a local controller?
